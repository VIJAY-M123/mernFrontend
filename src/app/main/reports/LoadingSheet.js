...
const LoadingSheet = () => {
  ...
  const onSubmit = ({ agency, fromDate, toDate, lsNumber }) => {
    const data = {
      rpt_report_code: 'LS0002_REP',
      dt_type1: 'I',
      var1: '@LS_CP_ID',
      int1: agency?.CP_ID,
      dt_type2: 'D',
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ComboBox
                      ...
                      type="autocomplete"
                      label="LS Number"
                      url={jwtServiceConfig.getLSMaster}
                      data={numberData}
                      error={!!errors.lsNumber}
                      helperText={errors.lsNumber?.message}
                      displayExpr="LS_NUMBER"
                      valueExpr="LS_ID"
